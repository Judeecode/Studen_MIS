...
if (is_logged_student()) header('Location: dashboard.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("SELECT id, password, full_name FROM students WHERE student_id = ?");
...
<div class="login-container">
  ...
  <div class="logo-section">
    <div class="logo-content">
      ...
      <div class="company-name">Student Portal</div>
    </div>
  </div>
  ...
  <div class="form-section">
    ...
    <div class="form-content">
      <div class="form-header">
        ...
        <p class="subtitle-text">PLEASE LOGIN TO STUDENT DASHBOARD.</p>
      </div>
      ...
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" id="student_id" name="student_id" class="form-input" required autocomplete="username" style="color: #000000 !important;">
        </div>
